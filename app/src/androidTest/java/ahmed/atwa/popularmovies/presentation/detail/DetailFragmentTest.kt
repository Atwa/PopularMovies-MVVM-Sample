...
import ahmed.atwa.popularmovies.commons.CustomMatcher
import ahmed.atwa.popularmovies.commons.CustomMatcher.hasItemAtPosition
import ahmed.atwa.popularmovies.di.DaggerTestAppComponent
...
class DetailFragmentTest {
    ...
    fun setup() {
        ...
        onView(withId(R.id.pb_loading)).check(ViewAssertions.doesNotExist());
    ...
    @Test
    fun initUI() {
        onView(withId(R.id.title_tv)).check(matches(ViewMatchers.isDisplayed()))
        onView(withId(R.id.title_tv)).check(matches(CustomMatcher.TextViewValueMatcher("2067")))
    }
    ...
    fun onSuccess_trailers_fetched() {
        ...
        onView(withId(R.id.trailers_loading)).check(matches(not(isDisplayed())))
        onView(hasItemAtPosition(0,hasDescendant(withText("2067 (2020) Trailer")))).check(matches(isDisplayed()));
    }
