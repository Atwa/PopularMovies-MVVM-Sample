...
import ahmed.atwa.popularmovies.databinding.FragmentMainBinding
...
class MainFragment : BaseFragment<FragmentMainBinding, MainFragmentViewModel>() ,MovieAdapter.MovieAdapterListener{
    ...
    override fun getViewModel(): MainFragmentViewModel {
        mMainFragmentViewModel = ViewModelProviders.of(this, mViewModelFactory).get(MainFragmentViewModel::class.java)
        return mMainFragmentViewModel
    }
    ...
    private fun subscribeToLiveData() {
        mMainFragmentViewModel.movieListLiveData.observe(this, Observer {mMainFragmentViewModel.addMovieItemsToList(it!!)} )
    }
